...
file_header = """# This file was generated by running ./tools/make-manuf.py for the macnuf library
# 
...
# https://github.com/erk-/macnuf/blob/main/data/manuf.txt
...
def get_csv(url: str) -> str:
    response = requests.get(
        url=url,
        headers={"User-Agent": "macnuf (https://github.com/erk-/macnuf)"},
    )
...
def main() -> None:
    ...
    with open("data/manuf.txt", "w+", encoding="utf-8") as manuf_file:
